    ...
    <div className="py-12 bg-gray-100 mx-auto px-12 sm:px-96">
      ...
      <div className="mb-6">
        ...
        <div className="mb-4">
          ...
          <p className="text-lg text-gray-700">Ends Feb 28, 2025</p>
        </div>
        <ul className='list-disc list-inside mb-1'>
          ...
          <li>T-Shirt</li>
          <li>
            <span className="font-semibold">Next 9 tickets get 80's in ACEpen gear!</span>
      ...
      <div>
        <p className="text-sm">
          * Gear is limited to the next 9 tickets sold
        </p>
      </div>
    </div>
  )
